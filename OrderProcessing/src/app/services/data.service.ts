...
export class DataService {
    ...
    //gets you order list associated with a business and order status type
    getOrdersBySellerIdAndOrderStatus(sellerId, config, orderStatus){
        return this._http.get(`${environment.newUrl}vendor/getOrdersBySellerId/${sellerId}?page=${config.page}&pageSize=${config.pageSize}&orderStatus=${orderStatus}`)
    }
